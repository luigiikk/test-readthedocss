...
===========================
This test smell occurs when complex or overly detailed data structures are used even when the test only requires minimal data to validate behavior.
...
.. note::
  Reduce test data to the minimum necessary to verify the behavior.